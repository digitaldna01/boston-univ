...
# Normal distribution
normal_samples = np.random.normal(loc=1/6, scale=1, size=num_samples) # mean 1/6

# Exponential distribution
exponential_samples = np.random.exponential(scale=1/6, size=num_samples) # mean 1/6

# Uniform distribution
uniform_samples = np.random.uniform(low=0, high=1/3, size=num_samples)  # Mean 1/6
...
plt.title('Comparison of inter-arrival Distributions')
